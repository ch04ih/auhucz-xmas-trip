...
const sources = {
  ...
  'ck-shuttle': { wiki: 'Český Krumlov' },
  'ck-town': { wiki: 'Český Krumlov' },
  'vltava-bend': { wiki: 'Český Krumlov', commons: 'Cesky Krumlov river bend' },
  'painted-tower': { wiki: 'Český Krumlov Castle' },
  'cloak-bridge': { wiki: 'Český Krumlov Castle', commons: 'Plášťový most' },
  krcma: { wiki: 'Czech cuisine', commons: 'vepřo knedlo zelo' },
