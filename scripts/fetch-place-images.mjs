...
const sources = {
  ...
  hofburg: { wiki: 'Hofburg' },
  stephansdom: { wiki: "St. Stephen's Cathedral, Vienna" },
  'mozarthaus-vienna': { wiki: 'Mozarthaus Vienna' },
  ...
  'kafka-statue': {
    wiki: 'Franz Kafka',
    commons: 'Statue of Franz Kafka by David Černý',
  },
  'powder-tower': { wiki: 'Powder Tower, Prague' },
